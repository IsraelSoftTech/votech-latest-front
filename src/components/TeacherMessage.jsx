...
import { FaEnvelope, FaPaperclip, FaTimes, FaFilePdf, FaImage, FaBars, FaUserGraduate, FaChalkboardTeacher, FaBook, FaMoneyBill, FaClipboardList, FaChartBar, FaFileAlt, FaPenFancy, FaTachometerAlt, FaSignOutAlt, FaIdCard, FaCog, FaPlus, FaSmile, FaUsers } from 'react-icons/fa';
              ...
              return (
                <div
                  ...
                  onClick={() => isGroup
                    ...
                    : navigate(`/teacher-messages/${chat.id}`)}
